# Generated by Django 5.0.3 on 2024-11-25 11:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.CharField(blank=True, help_text='Caminho relativo ao arquivo dentro de static/assets/', max_length=255, null=True, verbose_name='Caminho para a Logo da Cooperativa')),
            ],
        ),
        migrations.CreateModel(
            name='Institution',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('KG', 'KG'), ('UNI', 'UNI'), ('BDJ', 'BDJ'), ('L', 'L')], max_length=3, verbose_name='Unidade de Medida')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=2, max_digits=7, verbose_name='Saldo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=150, verbose_name='Nome Completo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ordered_quantity', models.DecimalField(decimal_places=2, max_digits=7, verbose_name='Quant. Pedida')),
                ('available_quantity', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Quant. Disponível')),
